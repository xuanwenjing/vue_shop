      ...
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
        <el-tabs v-model="activeIndex" @tab-click='tabClicked' :tab-position="'left'" :before-leave="beforeTabLeave">
          ...
          <el-tab-pane label="商品图片" name="3">
            <el-upload :action="uploadURL" :on-preview="handlePreview" :on-remove="handleRemove" list-type="picture" :headers="headerObj" :on-success="handldSuccess">
...
export default {
  data() {
    return {
      ...
      addFormRules: {
        goods_name: [{ required: true, message: '请输入商品', trigger: 'blur' }],
        goods_price: [{ required: true, message: '请输入商品', trigger: 'blur' }],
        goods_weight: [{ required: true, message: '请输入商品', trigger: 'blur' }],
        goods_number: [{ required: true, message: '请输入商品', trigger: 'blur' }],
